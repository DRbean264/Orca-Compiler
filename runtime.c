...
int stringLe(struct string * s, struct string * t) {
  int i;
  if (s == t)
    return 0;
  int res = s->length <= t->length;
...
int stringGt(struct string * s, struct string * t) {
  return 1 - stringLe(s, t);
}

int stringGe(struct string * s, struct string * t) {
  return 1 - stringLt(s, t);
}

// [lo, hi)]
void checkBound(i, lo, hi) {
  if (i < lo || i >= hi) {
