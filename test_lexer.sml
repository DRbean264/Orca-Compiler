...
struct
  fun test (filename, test_tokens) =
    ...
    in
      ...
      if token_list = test_tokens then
        print ("Test on " ^ filename ^ " passed!\n")
      else
        print
          ("Test on " ^ filename ^ " failed!\nExpected tokens: \n["
  ...
  fun test_all tests =
    foldl (fn (testcase, b) => (test testcase) andalso b) true tests
...
OS.Process.exit
  (if Test.test_all Test.test_answers then OS.Process.success
